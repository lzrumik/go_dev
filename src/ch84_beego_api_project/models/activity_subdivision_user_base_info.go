...
type ActivitySubdivisionUserBaseInfo struct {
...
func (t *ActivitySubdivisionUserBaseInfo) TableName() string {
	return "activity_subdivision_user_base_info"
}

func init() {
	orm.RegisterModel(new(ActivitySubdivisionUserBaseInfo))
}

// AddActivitySubdivisionUserBaseInfo insert a new ActivitySubdivisionUserBaseInfo into database and returns
// last inserted Id on success.
func AddActivitySubdivisionUserBaseInfo(m *ActivitySubdivisionUserBaseInfo) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}

// GetActivitySubdivisionUserBaseInfoById retrieves ActivitySubdivisionUserBaseInfo by Id. Returns error if
// Id doesn't exist
func GetActivitySubdivisionUserBaseInfoById(id int) (v *ActivitySubdivisionUserBaseInfo, err error) {
	o := orm.NewOrm()
	v = &ActivitySubdivisionUserBaseInfo{Id: id}
...
// GetAllActivitySubdivisionUserBaseInfo retrieves all ActivitySubdivisionUserBaseInfo matches certain condition. Returns empty list if
// no records exist
func GetAllActivitySubdivisionUserBaseInfo(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(ActivitySubdivisionUserBaseInfo))
	// query k=v
	for k, v := range query {
	...
	var l []ActivitySubdivisionUserBaseInfo
	qs = qs.OrderBy(sortFields...)
...
// UpdateActivitySubdivisionUserBaseInfo updates ActivitySubdivisionUserBaseInfo by Id and returns error if
// the record to be updated doesn't exist
func UpdateActivitySubdivisionUserBaseInfoById(m *ActivitySubdivisionUserBaseInfo) (err error) {
	o := orm.NewOrm()
	v := ActivitySubdivisionUserBaseInfo{Id: m.Id}
...
// DeleteActivitySubdivisionUserBaseInfo deletes ActivitySubdivisionUserBaseInfo by Id and returns error if
// the record to be deleted doesn't exist
func DeleteActivitySubdivisionUserBaseInfo(id int) (err error) {
	o := orm.NewOrm()
	v := ActivitySubdivisionUserBaseInfo{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&ActivitySubdivisionUserBaseInfo{Id: id}); err == nil {
