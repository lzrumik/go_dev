...
type FortuneCustomerBook20181015 struct {
	...
	AllotResult                string    `orm:"column(allot_result);size(300)" description:"分配结果"`
...
func (t *FortuneCustomerBook20181015) TableName() string {
	return "fortune_customer_book_20181015"
}

func init() {
	orm.RegisterModel(new(FortuneCustomerBook20181015))
}

// AddFortuneCustomerBook20181015 insert a new FortuneCustomerBook20181015 into database and returns
// last inserted Id on success.
func AddFortuneCustomerBook20181015(m *FortuneCustomerBook20181015) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}

// GetFortuneCustomerBook20181015ById retrieves FortuneCustomerBook20181015 by Id. Returns error if
// Id doesn't exist
func GetFortuneCustomerBook20181015ById(id int) (v *FortuneCustomerBook20181015, err error) {
	o := orm.NewOrm()
	v = &FortuneCustomerBook20181015{Id: id}
...
// GetAllFortuneCustomerBook20181015 retrieves all FortuneCustomerBook20181015 matches certain condition. Returns empty list if
// no records exist
func GetAllFortuneCustomerBook20181015(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(FortuneCustomerBook20181015))
	// query k=v
	for k, v := range query {
	...
	var l []FortuneCustomerBook20181015
	qs = qs.OrderBy(sortFields...)
...
// UpdateFortuneCustomerBook20181015 updates FortuneCustomerBook20181015 by Id and returns error if
// the record to be updated doesn't exist
func UpdateFortuneCustomerBook20181015ById(m *FortuneCustomerBook20181015) (err error) {
	o := orm.NewOrm()
	v := FortuneCustomerBook20181015{Id: m.Id}
...
// DeleteFortuneCustomerBook20181015 deletes FortuneCustomerBook20181015 by Id and returns error if
// the record to be deleted doesn't exist
func DeleteFortuneCustomerBook20181015(id int) (err error) {
	o := orm.NewOrm()
	v := FortuneCustomerBook20181015{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&FortuneCustomerBook20181015{Id: id}); err == nil {
