...
type FortuneCustomerBook20180621 struct {
...
func (t *FortuneCustomerBook20180621) TableName() string {
	return "fortune_customer_book_20180621"
}

func init() {
	orm.RegisterModel(new(FortuneCustomerBook20180621))
}

// AddFortuneCustomerBook20180621 insert a new FortuneCustomerBook20180621 into database and returns
// last inserted Id on success.
func AddFortuneCustomerBook20180621(m *FortuneCustomerBook20180621) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}

// GetFortuneCustomerBook20180621ById retrieves FortuneCustomerBook20180621 by Id. Returns error if
// Id doesn't exist
func GetFortuneCustomerBook20180621ById(id int) (v *FortuneCustomerBook20180621, err error) {
	o := orm.NewOrm()
	v = &FortuneCustomerBook20180621{Id: id}
...
// GetAllFortuneCustomerBook20180621 retrieves all FortuneCustomerBook20180621 matches certain condition. Returns empty list if
// no records exist
func GetAllFortuneCustomerBook20180621(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(FortuneCustomerBook20180621))
	// query k=v
	for k, v := range query {
	...
	var l []FortuneCustomerBook20180621
	qs = qs.OrderBy(sortFields...)
...
// UpdateFortuneCustomerBook20180621 updates FortuneCustomerBook20180621 by Id and returns error if
// the record to be updated doesn't exist
func UpdateFortuneCustomerBook20180621ById(m *FortuneCustomerBook20180621) (err error) {
	o := orm.NewOrm()
	v := FortuneCustomerBook20180621{Id: m.Id}
...
// DeleteFortuneCustomerBook20180621 deletes FortuneCustomerBook20180621 by Id and returns error if
// the record to be deleted doesn't exist
func DeleteFortuneCustomerBook20180621(id int) (err error) {
	o := orm.NewOrm()
	v := FortuneCustomerBook20180621{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&FortuneCustomerBook20180621{Id: id}); err == nil {
