...
type FortuneUserSubscriptionInfoBak struct {
...
func (t *FortuneUserSubscriptionInfoBak) TableName() string {
	return "fortune_user_subscription_info_bak"
}

func init() {
	orm.RegisterModel(new(FortuneUserSubscriptionInfoBak))
}

// AddFortuneUserSubscriptionInfoBak insert a new FortuneUserSubscriptionInfoBak into database and returns
// last inserted Id on success.
func AddFortuneUserSubscriptionInfoBak(m *FortuneUserSubscriptionInfoBak) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}

// GetFortuneUserSubscriptionInfoBakById retrieves FortuneUserSubscriptionInfoBak by Id. Returns error if
// Id doesn't exist
func GetFortuneUserSubscriptionInfoBakById(id int) (v *FortuneUserSubscriptionInfoBak, err error) {
	o := orm.NewOrm()
	v = &FortuneUserSubscriptionInfoBak{Id: id}
...
// GetAllFortuneUserSubscriptionInfoBak retrieves all FortuneUserSubscriptionInfoBak matches certain condition. Returns empty list if
// no records exist
func GetAllFortuneUserSubscriptionInfoBak(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(FortuneUserSubscriptionInfoBak))
	// query k=v
	for k, v := range query {
	...
	var l []FortuneUserSubscriptionInfoBak
	qs = qs.OrderBy(sortFields...)
...
// UpdateFortuneUserSubscriptionInfoBak updates FortuneUserSubscriptionInfoBak by Id and returns error if
// the record to be updated doesn't exist
func UpdateFortuneUserSubscriptionInfoBakById(m *FortuneUserSubscriptionInfoBak) (err error) {
	o := orm.NewOrm()
	v := FortuneUserSubscriptionInfoBak{Id: m.Id}
...
// DeleteFortuneUserSubscriptionInfoBak deletes FortuneUserSubscriptionInfoBak by Id and returns error if
// the record to be deleted doesn't exist
func DeleteFortuneUserSubscriptionInfoBak(id int) (err error) {
	o := orm.NewOrm()
	v := FortuneUserSubscriptionInfoBak{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&FortuneUserSubscriptionInfoBak{Id: id}); err == nil {
