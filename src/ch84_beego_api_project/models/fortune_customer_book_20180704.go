...
type FortuneCustomerBook20180704 struct {
...
func (t *FortuneCustomerBook20180704) TableName() string {
	return "fortune_customer_book_20180704"
}

func init() {
	orm.RegisterModel(new(FortuneCustomerBook20180704))
}

// AddFortuneCustomerBook20180704 insert a new FortuneCustomerBook20180704 into database and returns
// last inserted Id on success.
func AddFortuneCustomerBook20180704(m *FortuneCustomerBook20180704) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}

// GetFortuneCustomerBook20180704ById retrieves FortuneCustomerBook20180704 by Id. Returns error if
// Id doesn't exist
func GetFortuneCustomerBook20180704ById(id int) (v *FortuneCustomerBook20180704, err error) {
	o := orm.NewOrm()
	v = &FortuneCustomerBook20180704{Id: id}
...
// GetAllFortuneCustomerBook20180704 retrieves all FortuneCustomerBook20180704 matches certain condition. Returns empty list if
// no records exist
func GetAllFortuneCustomerBook20180704(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(FortuneCustomerBook20180704))
	// query k=v
	for k, v := range query {
	...
	var l []FortuneCustomerBook20180704
	qs = qs.OrderBy(sortFields...)
...
// UpdateFortuneCustomerBook20180704 updates FortuneCustomerBook20180704 by Id and returns error if
// the record to be updated doesn't exist
func UpdateFortuneCustomerBook20180704ById(m *FortuneCustomerBook20180704) (err error) {
	o := orm.NewOrm()
	v := FortuneCustomerBook20180704{Id: m.Id}
...
// DeleteFortuneCustomerBook20180704 deletes FortuneCustomerBook20180704 by Id and returns error if
// the record to be deleted doesn't exist
func DeleteFortuneCustomerBook20180704(id int) (err error) {
	o := orm.NewOrm()
	v := FortuneCustomerBook20180704{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&FortuneCustomerBook20180704{Id: id}); err == nil {
