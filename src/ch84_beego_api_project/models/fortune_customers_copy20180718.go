...
type FortuneCustomersCopy20180718 struct {
	...
	SamStatus                    int8      `orm:"column(sam_status)" description:"线上绑定客户经理时的状态，0未确定,1已确定"`
...
func (t *FortuneCustomersCopy20180718) TableName() string {
	return "fortune_customers_copy20180718"
}

func init() {
	orm.RegisterModel(new(FortuneCustomersCopy20180718))
}

// AddFortuneCustomersCopy20180718 insert a new FortuneCustomersCopy20180718 into database and returns
// last inserted Id on success.
func AddFortuneCustomersCopy20180718(m *FortuneCustomersCopy20180718) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}

// GetFortuneCustomersCopy20180718ById retrieves FortuneCustomersCopy20180718 by Id. Returns error if
// Id doesn't exist
func GetFortuneCustomersCopy20180718ById(id int) (v *FortuneCustomersCopy20180718, err error) {
	o := orm.NewOrm()
	v = &FortuneCustomersCopy20180718{Id: id}
...
// GetAllFortuneCustomersCopy20180718 retrieves all FortuneCustomersCopy20180718 matches certain condition. Returns empty list if
// no records exist
func GetAllFortuneCustomersCopy20180718(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(FortuneCustomersCopy20180718))
	// query k=v
	for k, v := range query {
	...
	var l []FortuneCustomersCopy20180718
	qs = qs.OrderBy(sortFields...)
...
// UpdateFortuneCustomersCopy20180718 updates FortuneCustomersCopy20180718 by Id and returns error if
// the record to be updated doesn't exist
func UpdateFortuneCustomersCopy20180718ById(m *FortuneCustomersCopy20180718) (err error) {
	o := orm.NewOrm()
	v := FortuneCustomersCopy20180718{Id: m.Id}
...
// DeleteFortuneCustomersCopy20180718 deletes FortuneCustomersCopy20180718 by Id and returns error if
// the record to be deleted doesn't exist
func DeleteFortuneCustomersCopy20180718(id int) (err error) {
	o := orm.NewOrm()
	v := FortuneCustomersCopy20180718{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&FortuneCustomersCopy20180718{Id: id}); err == nil {
