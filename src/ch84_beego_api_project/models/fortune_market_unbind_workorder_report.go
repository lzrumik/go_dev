...
type FortuneMarketUnbindWorkorderReport struct {
...
func (t *FortuneMarketUnbindWorkorderReport) TableName() string {
	return "fortune_market_unbind_workorder_report"
}

func init() {
	orm.RegisterModel(new(FortuneMarketUnbindWorkorderReport))
}

// AddFortuneMarketUnbindWorkorderReport insert a new FortuneMarketUnbindWorkorderReport into database and returns
// last inserted Id on success.
func AddFortuneMarketUnbindWorkorderReport(m *FortuneMarketUnbindWorkorderReport) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}

// GetFortuneMarketUnbindWorkorderReportById retrieves FortuneMarketUnbindWorkorderReport by Id. Returns error if
// Id doesn't exist
func GetFortuneMarketUnbindWorkorderReportById(id int) (v *FortuneMarketUnbindWorkorderReport, err error) {
	o := orm.NewOrm()
	v = &FortuneMarketUnbindWorkorderReport{Id: id}
...
// GetAllFortuneMarketUnbindWorkorderReport retrieves all FortuneMarketUnbindWorkorderReport matches certain condition. Returns empty list if
// no records exist
func GetAllFortuneMarketUnbindWorkorderReport(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(FortuneMarketUnbindWorkorderReport))
	// query k=v
	for k, v := range query {
	...
	var l []FortuneMarketUnbindWorkorderReport
	qs = qs.OrderBy(sortFields...)
...
// UpdateFortuneMarketUnbindWorkorderReport updates FortuneMarketUnbindWorkorderReport by Id and returns error if
// the record to be updated doesn't exist
func UpdateFortuneMarketUnbindWorkorderReportById(m *FortuneMarketUnbindWorkorderReport) (err error) {
	o := orm.NewOrm()
	v := FortuneMarketUnbindWorkorderReport{Id: m.Id}
...
// DeleteFortuneMarketUnbindWorkorderReport deletes FortuneMarketUnbindWorkorderReport by Id and returns error if
// the record to be deleted doesn't exist
func DeleteFortuneMarketUnbindWorkorderReport(id int) (err error) {
	o := orm.NewOrm()
	v := FortuneMarketUnbindWorkorderReport{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&FortuneMarketUnbindWorkorderReport{Id: id}); err == nil {
