...
type FortuneMarketBindWorkorder struct {
	...
	TimeNoticeTaskStatus  int8      `orm:"column(time_notice_task_status)" description:"0=初始、1=扫描中、2=标记24小时内已建工单"`
...
func (t *FortuneMarketBindWorkorder) TableName() string {
	return "fortune_market_bind_workorder"
}

func init() {
	orm.RegisterModel(new(FortuneMarketBindWorkorder))
}

// AddFortuneMarketBindWorkorder insert a new FortuneMarketBindWorkorder into database and returns
// last inserted Id on success.
func AddFortuneMarketBindWorkorder(m *FortuneMarketBindWorkorder) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}

// GetFortuneMarketBindWorkorderById retrieves FortuneMarketBindWorkorder by Id. Returns error if
// Id doesn't exist
func GetFortuneMarketBindWorkorderById(id int) (v *FortuneMarketBindWorkorder, err error) {
	o := orm.NewOrm()
	v = &FortuneMarketBindWorkorder{Id: id}
...
// GetAllFortuneMarketBindWorkorder retrieves all FortuneMarketBindWorkorder matches certain condition. Returns empty list if
// no records exist
func GetAllFortuneMarketBindWorkorder(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(FortuneMarketBindWorkorder))
	// query k=v
	for k, v := range query {
	...
	var l []FortuneMarketBindWorkorder
	qs = qs.OrderBy(sortFields...)
...
// UpdateFortuneMarketBindWorkorder updates FortuneMarketBindWorkorder by Id and returns error if
// the record to be updated doesn't exist
func UpdateFortuneMarketBindWorkorderById(m *FortuneMarketBindWorkorder) (err error) {
	o := orm.NewOrm()
	v := FortuneMarketBindWorkorder{Id: m.Id}
...
// DeleteFortuneMarketBindWorkorder deletes FortuneMarketBindWorkorder by Id and returns error if
// the record to be deleted doesn't exist
func DeleteFortuneMarketBindWorkorder(id int) (err error) {
	o := orm.NewOrm()
	v := FortuneMarketBindWorkorder{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&FortuneMarketBindWorkorder{Id: id}); err == nil {
